...
public class RobotContainer {
    ...
    BallDetection balldetector = new BallDetection(3); // Device number determined by jumpers on the board
    Lights lights = new Lights(3);
    ...
    public Command getTeleopCommand() {
        return new DualJoystickDrive(drivetrain, stickLeft, stickRight);
    }
}
